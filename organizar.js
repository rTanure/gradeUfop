const data = [
    ...
    },
    {
     "id": "CEA062",
     "nome": "FISICA II",
     "requisitos": "CEA038     CEA039     CEA051\nCEA061"
    },
    {
     "id": "CEA063",
     "nome": "FISICA III",
    ...
    },
    {
     "id": "CEA064",
     "nome": "FISICA IV",
     "requisitos": "CEA052     CEA056     CEA062\nCEA063"
    },
    {
     "id": "CEA552",
    ...
    },
    {
     ...
     "requisitos": "CEA057     CEA064     CEA552\nCSI148"
    },
    {
     "id": "CEA562",
    ...
    {
     "id": "EAD344",
     "nome": "TEORIA DA ADMINISTRACAO I"
    },
    {
     "id": "CEA572",
     "nome": "INSTRUMENTACAO",
...
// Colocar dados sem a separação de periodos
const newData = data
for(materia of data) {
    if(materia != null) {
        if(materia.requisitos == undefined) {
            materia.requisitos = []
        } else {
            let splited = materia.requisitos.split(' ')
            let newSplited = []
            for(temp of splited ) {
                if(temp != "") {
                    newSplited.push(temp)
                } 
            }
            materia.requisitos = newSplited
        }
    }
}
console.log(newData)